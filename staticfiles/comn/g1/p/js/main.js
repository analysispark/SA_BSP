$(document).ready(function () {
    ...
    */
    ...
    /* 2022.09.16 추가 */
    $('#hiddenSearchClose').on("focus", function(e) {
        $('.searchPop-close').click();
    });
    
    $('#hiddenAllMenuClose').on("focus", function(e) {
        $('.totalMenu .btn-close').click();
    });
    
    $('#headerBtnSearch').on("focus", function(e) {
        $('.header .searchPop').fadeIn();
        $('.header .searchPop input').focus();
    });
    
    $('#headerBthAllMenu').on("focus", function(e) {
        $('.totalMenu').fadeIn();
        $('body').css('overflow-y', 'hidden');
    });
    ...
    $('#box1').on("keydown", function(e) {
        if(e.keyCode==13) {
            document.location.href = $("#link1").attr("href");
        }
    });
    ...
    $('#box3').on("keydown", function(e) {
        if(e.keyCode==13) {
            document.location.href = $("#link3").attr("href");
        }
    });
    $('#box4').on("keydown", function(e) {
        if(e.keyCode==13) {
            document.location.href = $("#link4").attr("href");
        }
    });
});
